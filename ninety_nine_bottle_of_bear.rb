...
num = 9999
while num > 0
  puts  "#{ englishNumber num} bottles of beer on the wall, #{ englishNumber num} bottles of beer!"
  num -= 1
  if num >1
    puts "Take one down, passing around, #{ englishNumber num} bottles of beer on the wall !"
  else
    puts "Take one down, passing around, no more bottles of beer on the wall !"
  end
end
